...
**The question we answer:** _How do river systems change — and where will be at risk in 10, 20, 30, 50 years?_
...
- Identify which villages and infrastructure will be in danger _before_ it happens
...
|                | Link                                                                                  |
| -------------- | ------------------------------------------------------------------------------------- |
| **Web App**    | `https://aquasentinel-gold.vercel.app/` _(deploy after setup)_                        |
| **API Docs**   | `https://one1th-cassini-hackathon.onrender.com/docs` _(deploy after setup)_           |
